            ...
            <div class="flex flex-wrap -m-2">
              ...
              <div class="p-2 w-full">
                ...
                <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                  <input id="is_selling-1" type="radio" v-model="form.is_selling" value="1" name="is_selling"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                  <label for="is_selling-1"
                    class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">販売中</label>
                </div>
                <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                  <input checked id="is_selling-2" type="radio" v-model="form.is_selling" value="2" name="is_selling"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                  <label for="is_selling-2"
                    class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">停止中</label>
                </div>
              </div>
              <div class="p-2 w-full">
                <button
