                  ...
                  <section class="text-gray-600 body-font">
                    ...
                    <div class="container px-5 py-8 mx-auto">
                      ...
                      <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                        <Link :href="route('items.create')" as="button" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">新規追加</Link>
                      </div>
